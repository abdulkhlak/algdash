        ...
        <section class="content">
            <div class="row">
                <section class="content-header">
                    <h1><a href="{{route('price_add')}}" class="btn btn-primary">{{ __('Add New')}}</a></h1>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($prices as $key => $price)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('price_edit', base64_encode($price->id))}}"
                                               class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            <a href="{{route('price_delete', base64_encode
                                     ($price->id))}}" id="delete" class="btn btn-sm btn-primary"><i class="fa fa-trash"></i></a></td>
