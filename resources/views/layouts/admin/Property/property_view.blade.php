        ...
        <section class="content">
            <div class="row">
                <section class="content-header">
                    <h1><a href="{{route('property_add')}}" class="btn btn-primary">{{ __('Add New')}}</a></h1>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($propertys as $key => $property)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('property_edit', base64_encode($property->id))}}"
                                               class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            <a href="{{route('property_delete', base64_encode
                                     ($property->id))}}" id="delete" class="btn btn-sm btn-primary"><i class="fa fa-trash"></i></a></td>
